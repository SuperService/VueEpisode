...
// const productStore2Altogic = useProductStore2Altogic();
// useAsyncData("products", async () => productStore2Altogic.fetchProducts());
  ...
  <div>
    ...
    >
      <TransitionGroup name="products">
        <!-- <ProductCard2Altogic
          v-for="product in productStore2Altogic.products"
          :product="product"
          :key="product._id"
          class="mb-5"
        /> -->
